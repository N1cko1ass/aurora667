...
class Translation:
    ...
    """
    with open("Trans_commands.json", "r", encoding="UTF-8") as file:
...
def use_offline_recognition():
    ...
    try:
        ...
        if not os.path.exists(r"C:\Users\ asus\Desktop\Programs\Aurora\ vosk-model-ru-0.22"):
...
def make_preparations():
    ...
    load_dotenv('241524106d93e939aebd9b90d8a7b19a')
